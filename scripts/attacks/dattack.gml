...
set_window_value(AT_DATTACK, 1, AG_WINDOW_HSPEED, 2.25); //moves 18 in total (hsp = 18/windowlength)
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX_FRAME, 11);
...
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 125);
...
set_hitbox_value(AT_DATTACK, 3, HG_WIDTH, 112);
