...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("speech_bubble"));
...
set_window_value(AT_NSPECIAL_2, 3, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_window_value(AT_NSPECIAL_2, 4, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_X, 90);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_Y, -38);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_WIDTH, 100);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HEIGHT, 66);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_EXTRA_HITPAUSE, 36);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HIT_SFX, sound_get("slash2"));
