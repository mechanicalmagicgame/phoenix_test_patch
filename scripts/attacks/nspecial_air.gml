...
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_SFX, sound_get("speech_bubble"));
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_SFX_FRAME, 23);
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_VSPEED, -1.2);
...
set_window_value(AT_NSPECIAL_AIR, 2, AG_WINDOW_VSPEED, -4.4);
...
set_window_value(AT_NSPECIAL_AIR, 3, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_window_value(AT_NSPECIAL_AIR, 4, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITBOX_X, 90);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITBOX_Y, -6);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_WIDTH, 100);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HEIGHT, 66);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_EXTRA_HITPAUSE, 36);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HIT_SFX, sound_get("slash2"));
