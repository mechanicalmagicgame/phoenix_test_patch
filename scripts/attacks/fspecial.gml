...
set_hitbox_value(AT_FSPECIAL, 1, HG_KNOCKBACK_SCALING, .32);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("evidence_proj1"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, .2);

set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_HSPEED, 7.5);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_VSPEED, -9);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_GRAVITY, 0.7);
