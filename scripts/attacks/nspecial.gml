...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("speech_bubble"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_EXTRA_HITPAUSE, 36);
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("slash2"));
